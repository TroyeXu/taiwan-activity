...
export const searchParamsSchema = z.object({
  ...
  timeFilter: z
    .enum(['today', 'tomorrow', 'this_week', 'this_weekend', 'next_week', 'this_month'])
    .optional(),
...
// API 回應格式化
export function createApiResponse<T>(data: T, message?: string, pagination?: any): ApiResponse<T> {
  return {
    success: true,
    data,
    message,
...
export function createApiError(statusCode: number, message: string, details?: any) {
  throw createError({
    statusCode,
...
// SQL 查詢條件建構器
export function buildWhereConditions(_filters: unknown) {
